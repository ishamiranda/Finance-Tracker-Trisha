    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div
            id="compliment-popup"
            className="bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 dark:from-pink-900/95 dark:via-purple-900/95 dark:to-blue-900/95 backdrop-blur-md shadow-2xl rounded-3xl max-w-md w-full mx-auto overflow-hidden relative animate-scale-in"
          >
            {/* Close Button */}
            <button
              onClick={closePopup}
